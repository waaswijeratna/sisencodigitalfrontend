  ...
  return (
    <main className="min-h-screen bg-[#f4f1ea] px-6 py-8 text-[#20382e]">
      <div className="mx-auto max-w-5xl">
        ...
        <p className="pt-12 text-sm font-semibold uppercase tracking-[0.2em] text-[#d36b42]">Admin workspace</p>
        <h1 className="mt-3 text-5xl font-semibold tracking-tight">Good to see you, {user?.name}.</h1>
        <p className="mt-4 text-lg text-[#657066]">You are signed in as an administrator.</p>
      </div>
    </main>
  );
}